...
INSERT INTO GoodyHutSubTypes (GoodyHut, SubTypeGoodyHut, Description, Weight, ModifierID)
  VALUES ('GOODYHUT_CULTURE', 'GOODY_LARGE_CULTURE', 'LOC_GOODYHUT_LARGE_CULTURE_DESCRIPTION', '25', 'GOODY_CULTURE_LARGE_MODIFIER');
...
INSERT INTO GoodyHutSubTypes (GoodyHut, SubTypeGoodyHut, Description, Weight, ModifierID, RequiresUnit)
  VALUES ('GOODYHUT_MILITARY', 'GOODY_GRANT_SPY', 'LOC_GOODYHUT_MILITARY_GRANT_SPY', '15', 'GOODY_MILITARY_GRANT_SPY', '1');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent)
...
INSERT INTO GoodyHutSubTypes (GoodyHut, SubTypeGoodyHut, Description, Weight, ModifierID)
  VALUES ('GOODYHUT_GOLD', 'GOODY_GREAT_MERCHANT_POINTS', 'LOC_GOODYHUT_GOLD_GREAT_MERCHANT_POINTS', '25', 'GOODY_GOLD_GREAT_MERCHANT_POINTS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent)
...
INSERT INTO ModifierArguments (ModifierId, Name, Type, Value)
  VALUES ('GOODY_GOLD_GREAT_MERCHANT_POINTS', 'Amount', 'ARGTYPE_IDENTITY', '35');

-- add great engineer points bonus to goody huts
INSERT INTO GoodyHutSubTypes (GoodyHut, SubTypeGoodyHut, Description, Weight, ModifierID)
  VALUES ('GOODYHUT_MILITARY', 'GOODY_GREAT_ENGINEER_POINTS', 'LOC_GOODYHUT_GREAT_ENGINEER_POINTS', '25', 'GOODY_GREAT_ENGINEER_POINTS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent)
...
INSERT INTO ModifierArguments (ModifierId, Name, Type, Value)
  VALUES ('GOODY_GREAT_ENGINEER_POINTS', 'Amount', 'ARGTYPE_IDENTITY', '35');

-- add great prophet points bonus to goody huts
INSERT INTO GoodyHutSubTypes (GoodyHut, SubTypeGoodyHut, Description, Weight, ModifierID)
  VALUES ('GOODYHUT_FAITH', 'GOODY_GREAT_PROPHET_POINTS', 'LOC_GOODYHUT_FAITH_GREAT_PROPHET_POINTS', '25', 'GOODY_FAITH_GREAT_PROPHET_POINTS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent)
...
INSERT INTO ModifierArguments (ModifierId, Name, Type, Value)
  VALUES ('GOODY_FAITH_GREAT_PROPHET_POINTS', 'Amount', 'ARGTYPE_IDENTITY', '35');
...
UPDATE Improvements SET TilesPerGoody = '28' WHERE ImprovementType = 'IMPROVEMENT_GOODY_HUT';
